...
# Use environment variables with fallback to local paths
OUTPUT_DIR = Path(os.getenv("OUTPUT_DIR", "./vibecheck_full_output"))
DB_PATH = Path(os.getenv("DB_PATH", OUTPUT_DIR / "vibecheck.db"))
IMAGE_DIR = Path(os.getenv("IMAGE_DIR", OUTPUT_DIR / "images"))
...
VIBE_MAP_CSV = Path(os.getenv("VIBE_MAP_CSV", OUTPUT_DIR / "vibe_map.csv"))
